...
namespace Qs.IO.Indexation
{
    public class HeritachyType
    {
        ...
        public Class Type
        {
            get
            {
                return Genre == Genre.Type ? Scop as Class : (Genre == Genre.Method ? (Scop as Method).Return : (Genre == Genre.None ? null : Scop as FieldInfo).Return);
            }
        }
        ...
        public Genre Genre
        {
            get
            {
                ...
                if ( Scop is Method ) return Genre.Method;
                return Genre.None;
            }
        }
